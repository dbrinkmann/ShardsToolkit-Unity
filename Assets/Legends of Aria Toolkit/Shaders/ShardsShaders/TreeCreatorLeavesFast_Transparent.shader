...
Shader "Custom Nature/Tree Creator Leaves Fast - Transparent" {
Properties {
...
SubShader { 
	Tags {
		...
		"Queue"="Geometry+2" "RenderType"="Transparent" 
	}
	LOD 200
	...
	CGPROGRAM
		...
		float4 FragmentLeaf (v2f_leaf IN) : COLOR
		{
			...
			return float4 (col.rgb * light, col.a * _Alpha );
		}
...
Dependency "OptimizedShader" = "Custom Nature/Tree Creator Leaves Fast Optimized - Transparent"
FallBack "Diffuse"
}
